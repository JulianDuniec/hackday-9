var 
  ...
  InitialBrain = require('./InitialBrain3-random'),
...
module.exports = function(options) {
  ...
  me.setRandomGoal = function() {
    ...
    mutationRate : 0.15,
    fastMode : false, //No visualization
    maxPerbutation : 0.1,
    survivalRate : 0.2,
    randomPosition : true
	};
  ...
  me.getInitialPosition = function() {
    if(me.initSettings.randomPosition == true)
        return   {x : Math.random() * me.width, y : Math.random() * me.height};
	...
	me.init = function(brains) {
    	...
    	var organism = new Organism({
				brain : brains[i],
				position : me.getInitialPosition()});
    ...
    if(me.initSettings.fastMode == false)
